module.exports = (function() {
  ...
  function peg$parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c8 = function(line) { return line; },
        peg$c9 = "//",
    ...
    function peg$parseStructure() {
      ...
      s0 = peg$currPos;
      s1 = peg$parseMaybeQuoted();
      if (s1 !== peg$FAILED) {
        s2 = peg$parseWhitespace();
        if (s2 !== peg$FAILED) {
          s3 = peg$parseStructureContent();
          if (s3 !== peg$FAILED) {
            s4 = [];
    ...
    function peg$parseEmptyStructure() {
      var s0, s1, s2, s3;
    ...
    function peg$parseStructureContent() {
      var s0, s1, s2, s3;
    ...
    function peg$parseStructureLine() {
      var s0, s1, s2;
    ...
    function peg$parseCommentOrLine() {
      var s0, s1, s2, s3;
    ...
    function peg$parseLineValue() {
      ...
      s0 = peg$parseQuoted();
      if (s0 === peg$FAILED) {
        s0 = peg$parseEmptyStructure();
        if (s0 === peg$FAILED) {
          s0 = peg$parseStructureContent();
        }
      }
